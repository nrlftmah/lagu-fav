...
dataLagu.forEach(([judul, artis, gambar, likes, played, audio]) => {
    ...
    card.innerHTML = `
        ...
        <button onclick="pauseAllExcept('audio-${judul}'); document.getElementById('audio-${judul}').play()">▶</button>
        <button class="pause" onclick="document.getElementById('audio-${judul}').pause()">⏸</button>
    `;
